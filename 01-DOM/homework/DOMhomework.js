...
function displayToDos() {
  ...
  var funcion = buildToDos(toDoItems);
  funcion.map((t)=> toDoContainer.appendChild(t))
}
...
function addToDo() {
  // Tu código acá:
  var crear = document.getElementById("toDoInput").value; 
  var newToDo = new ToDo(crear)
